// This module contains only calculations related to companies
...
const calculateTaxesAmount = (
  ...
  console.log(
    `CalculateNet gross:${taxableAmount} ires:${iresPercentage} irap:${irapPercentage}`
  );
...
type TaxesOutcome = [netAmount: number, iresAmount: number, irapAmount: number];
